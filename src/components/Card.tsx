        ...
        <div className="p-4 pb-0">
          ...
          <div className="flex flex-row justify-between pt-2">
            <div className="flex flex-row items-center space-x-1">
              ...
              <span className="text-sm">{this.props.product.stock}</span>
            </div>
          ...
          <div className="w-[90%]  mx-auto h-[56px] border border-b-0 rounded-tl-full rounded-tr-full flex flex-row items-center content-center mt-4">
            <div className="mx-auto flex space-x-7">
              <span title={`${this.props.product.delivery ? 'Free delivery' : 'Paid delivery'}`}>
                <IconDelivery
                  className={`w-[24px] h-[24px]  ${
                    this.props.product.delivery ? 'fill-amber-400' : 'fill-slate-200'
                  }`}
                />
              </span>
              <span>
              ...
              >
                <IconTracking
                  className={`w-[24px] h-[24px]  ${
                    this.props.product.tracking ? 'fill-orange-600' : 'fill-slate-200'
                  }`}
                />
              </span>
            </div>
